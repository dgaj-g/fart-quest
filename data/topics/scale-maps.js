...
<p>Length: 5 × 4 = 20 m. Width: 3 × 4 = 12 m. Two separate sums, same recipe both times. Never mix a length reading with a width reading — always keep your labels straight!</p>`,
    ...
    {
      type: 'talk',
      text: 'Now, a Whiffbeard-approved warning: examiners LOVE asking you to compare two routes drawn at different scales. Do not be fooled into comparing the raw drawing numbers — a route that LOOKS shorter on paper can be the longer one in real life if its scale is bigger! Always convert BOTH routes to real distances FIRST, then compare.',
    },
    {
      type: 'try',
      q: {
        id: 'sm-try-2', topicId: 'scale-maps', tier: 2, format: 'mcq5',
        stem: 'Route A: scale 1 cm = 5 m, drawn <b>4 cm</b>. Route B: scale 1 cm = 3 m, drawn <b>9 cm</b>. How many metres LONGER is Route B than Route A?',
        options: [
          { text: '7 m', misconception: null },
          { text: '20 m', misconception: 'forgot-to-subtract' },
          { text: '47 m', misconception: 'added-not-subtracted' },
          { text: '5 m', misconception: 'no-convert' },
          { text: '10 m', misconception: 'padded-near-miss' },
        ],
        correctIndex: 0,
        hintSteps: [
          'Convert EACH route to real life first: Route A = 4 × 5, Route B = 9 × 3.',
          '20 m and 27 m — what is the difference between them?',
        ],
        explain: {
          rule: 'Read the scale like a recipe: 1 cm means X in real life. Measure, then multiply.',
          worked: 'Route A: 4 × 5 = 20 m. Route B: 9 × 3 = 27 m. Difference = 7 m.',
          whyWrong: {
            '20 m': 'That is only Route A’s real length — the question wants the DIFFERENCE between the two.',
            '47 m': 'That ADDED the two real lengths together — for "how much longer", subtract them instead.',
            '5 m': 'That is just the raw drawing lengths (9 − 4), unconverted — you have not used the scales yet!',
            '10 m': 'Check the real distances again: 20 m and 27 m, not the raw drawing numbers.',
          },
        },
      },
    },
...
<p>Two clean steps, never one guess: multiply for the metres, then climb the ladder for the kilometres.</p>`,
  ...
  tips: [
    ...
    'Comparing two routes? Convert EACH one to real life first, then compare — never compare the raw drawing lengths.',

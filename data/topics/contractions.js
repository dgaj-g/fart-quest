...
<p>This test works every single time, on every squeeze in the whole passage.</p>`,
  ...
  tips: [
    ...
    "Match the squeeze to the subject: one thing gets hasn't/doesn't/wasn't, more than one gets haven't/don't/weren't.",
  ],
  ...
  bank: [
    ...
    },
    {
      ...
      stemParts: ['By the time the whistle finally blew, the two exhausted brothers ', ' ready for a second half.'],
      options: [
        { text: "weren't", misconception: null },
        { text: "wasn't", misconception: 'wrong-subject-number' },
        { text: 'werent', misconception: 'missing-apostrophe' },
        { text: "were'nt", misconception: 'misplaced-apostrophe' },
        { text: "were not't", misconception: 'double-marked' },
      ],
      correctIndex: 0,
      hintSteps: [
        'Count who this is about — one brother, or two?',
        'Two brothers together need "weren\'t" (were not), not the one-person form "wasn\'t".',
      ],
      explain: {
        rule: WEAPON_RULE,
        worked: '"Weren\'t" squeezes "were not" — TWO brothers need "were", so the plural squeeze weren\'t is correct here.',
        whyWrong: {
          "wasn't": 'That squeezes "was not" — the correct form for just ONE person, not two brothers together.',
          werent: 'The apostrophe has vanished — without it, this is not a proper squeeze.',
          "were'nt": 'The apostrophe has landed one letter too early — the missing letter is the "o" in "not".',
          "were not't": 'That keeps "not" fully spelled out AND bolts on an extra squeeze — only one version is ever needed.',
        },
      },
    },
    {
      id: 'contractions-t3-07', tier: 3, format: 'clozebox',
      stemParts: ['By the time bedtime finally arrives, Whiffbeard still ', ' finished his beard-oiling ritual.'],
      options: [
        { text: "hasn't", misconception: null },
        { text: "haven't", misconception: 'wrong-subject-number' },
        { text: 'hasnt', misconception: 'missing-apostrophe' },
        { text: "has'nt", misconception: 'misplaced-apostrophe' },
        { text: "has not't", misconception: 'double-marked' },
      ],
      correctIndex: 0,
      hintSteps: [
        'Count who this is about — one person, or more than one?',
        'ONE Whiffbeard needs "hasn\'t" (has not), not the many-people form "haven\'t".',
      ],
      explain: {
        rule: WEAPON_RULE,
        worked: '"Hasn\'t" squeezes "has not" — ONE Whiffbeard needs "has", so the singular squeeze hasn\'t is correct here.',
        whyWrong: {
          "haven't": 'That squeezes "have not" — the correct form for more than one person, not a single Whiffbeard.',
          hasnt: 'The apostrophe has vanished — without it, this is not a proper squeeze.',
          "has'nt": 'The apostrophe has landed one letter too early — the missing letter is the "o" in "not".',
          "has not't": 'That keeps "not" fully spelled out AND bolts on an extra squeeze — only one version is ever needed.',
        },
      },
    },
    {
      id: 'contractions-t3-08', tier: 3, format: 'clozebox',
      stemParts: ['Ever since the storm, the old scoreboard simply ', ' work properly during matches.'],
      options: [
        { text: "doesn't", misconception: null },
        { text: "don't", misconception: 'wrong-subject-number' },
        { text: 'doesnt', misconception: 'missing-apostrophe' },
        { text: "does'nt", misconception: 'misplaced-apostrophe' },
        { text: "does not't", misconception: 'double-marked' },
      ],
      correctIndex: 0,
      hintSteps: [
        'Count what this is about — one scoreboard, or many?',
        'ONE scoreboard needs "doesn\'t" (does not), not the plural form "don\'t".',
      ],
      explain: {
        rule: WEAPON_RULE,
        worked: '"Doesn\'t" squeezes "does not" — ONE scoreboard needs "does", so the singular squeeze doesn\'t is correct here.',
        whyWrong: {
          "don't": 'That squeezes "do not" — the correct form for a plural subject, not one single scoreboard.',
          doesnt: 'The apostrophe has vanished — without it, this is not a proper squeeze.',
          "does'nt": 'The apostrophe has landed one letter too early — the missing letter is the "o" in "not".',
          "does not't": 'That keeps "not" fully spelled out AND bolts on an extra squeeze — only one version is ever needed.',
        },
      },
    },
    {

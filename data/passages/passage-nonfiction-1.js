...
export default {
  ...
  questions: [
    ...
    // ---- Q7: text feature ----
    {
      id: 'passage-nonfiction-1-q7', tier: 2, format: 'mcq5', skill: 'text', lineRef: '13',
      stem: 'What is the purpose of a subheading like the one on <b>line 13</b>, "Why Does It Smell So Terrible?"',
      options: [
        { text: 'To tell the reader what that section of the report is about', misconception: null },
        { text: 'To show that a character is speaking', misconception: 'fiction-confusion' },
        { text: 'To list step-by-step instructions', misconception: 'wrong-text-type' },
        { text: 'To give the rhyme at the end of a verse', misconception: 'poetry-confusion' },
      ],
      correctIndex: 0,
      hintSteps: [
        'This report is non-fiction, built from fact, organised with signposts for the reader.',
        'A subheading sits above a chunk of writing — what job would that position do for a reader skimming the report?',
      ],
      explain: {
        rule: RULE_TEXT,
        worked: 'This is a non-fiction report, and subheadings like "Why Does It Smell So Terrible?" act as signposts — they tell the reader exactly what fact-based topic the section below covers.',
        whyWrong: {
          'To show that a character is speaking': 'Speech is shown with speech marks and characters, which belong in fiction, not this fact-based report.',
          'To list step-by-step instructions': 'The report explains facts about a flower — it is not a set of instructions to follow.',
          'To give the rhyme at the end of a verse': 'This report has no verses or rhymes; that idea belongs to poetry.',
        },
      },
    },
    // ---- Q8-Q13: wordentry ----
    ...
    },
    {
      ...
      stem: 'How many subheadings does this report have, including the final "Conclusion" heading?',
      hint: 'one number', maxLen: 10,
      accept: ['7', 'seven', 'Seven'],
      hintSteps: [
        'A subheading sits alone above a section, signposting what that section is about — count every one, including "Conclusion".',
        'Count them in order: What Is Rafflesia?, Why Does It Smell So Terrible?, Where Does It Grow?, How the Flower Feeds Itself, The World\'s Tallest Stinker: Titan Arum, A Very Short Life, Conclusion.',
      ],
      explain: {
        rule: RULE_TEXT,
        worked: 'Counting every signpost heading in the report — six topic subheadings plus the final "Conclusion" heading — gives a total of 7.',
      },
    },
  ],
};

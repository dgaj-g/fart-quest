...
export default {
  ...
  questions: [
    ...
    {
      id: 'passage-poem-1-q7', tier: 3, format: 'mcq5', skill: 'lang', lineRef: '14',
      stem: 'In <b>line 14</b>, "a BOOM that sent boulders bouncing like drums," which language technique is used, and what effect does it create?',
      options: [
        { text: 'Simile — comparing the boulders to drums makes the crash feel loud and rhythmic, like a whole drumline', misconception: null },
        { text: 'Metaphor — it says the boulders actually WERE drums', misconception: 'confused-technique' },
        { text: 'It proves that Nigel keeps real drums hidden in his cave', misconception: 'silly-wrong' },
        { text: 'It tells us the exact number of boulders that rolled down the mountain', misconception: 'clearly-wrong' },
      ],
      correctIndex: 0,
      hintSteps: [
        'Look for the small joining word that compares two things — do you see "like" or "as" in line 14?',
        'A simile compares using "like" or "as" — spot it, then ask what feeling that comparison creates.',
      ],
      explain: {
        rule: RULE_LANG,
        worked: 'The boulders bouncing are compared to drums using the word "like" — that comparing word makes it a simile, not a metaphor. The effect: it makes the crash sound loud and rhythmic, almost musical, like a whole drumline crashing down the mountain.',
        whyWrong: {
          'Metaphor — it says the boulders actually WERE drums': 'Look again — line 14 uses "like" to compare, so it\'s a simile; a metaphor would drop "like" and just say the boulders WERE drums.',
          'It proves that Nigel keeps real drums hidden in his cave': 'No real drums appear anywhere in the poem — this is a comparison of sound, not a fact about hidden instruments.',
          'It tells us the exact number of boulders that rolled down the mountain': 'No count of boulders is given anywhere in this line — it\'s about the sound they make, not a number.',
        },
      },
    },

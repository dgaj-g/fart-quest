...
export default {
  ...
  questions: [
    ...
    {
      id: 'passage-nonfiction-2-q7', tier: 2, format: 'mcq5', skill: 'text', lineRef: '15',
      stem: 'Why has the writer split this report into sections with subheadings, such as \'How A Submarine Dives\'?',
      options: [
        { text: 'To signpost the reader to each new piece of information', misconception: null },
        { text: 'To make the report rhyme like a poem', misconception: 'confuses-genre' },
        { text: 'Because the writer ran out of things to say', misconception: 'silly-misread' },
        { text: 'To hide the most important facts from the reader', misconception: 'opposite-effect' },
        { text: 'To make the report exactly fifty pages long', misconception: 'irrelevant' },
      ],
      correctIndex: 0,
      explain: {
        rule: TEXT_RULE,
        worked: 'Just like a contents page shows where chapters start, subheadings act as signposts inside a non-fiction report — each one tells the reader exactly what new fact is coming next, like "How A Submarine Dives" announcing the diving section.',
        whyWrong: {
          'To make the report rhyme like a poem': 'This report is non-fiction, not poetry — subheadings never create rhyme.',
          'Because the writer ran out of things to say': 'The opposite is true — each subheading introduces MORE information, not less.',
          'To hide the most important facts from the reader': 'Subheadings do the opposite job — they help the reader FIND facts quickly.',
          'To make the report exactly fifty pages long': 'Subheadings are about organising ideas, never about page count.',
        },
      },
      hintSteps: [
        'Think about what a contents page or index does in a non-fiction book — subheadings do a similar job inside the report itself.',
        'Fiction is invented; non-fiction is fact — subheadings are a non-fiction tool for organising real information.',
      ],
    },
    ...
    },
    {
      ...
      explain: {
        rule: LANG_RULE,
        worked: '"Gracefully" describes HOW the huge machine rises — that job (describing a verb) makes it an adverb. The writer picked this word for an EFFECT: it makes a giant steel submarine feel elegant, not clumsy.',
      },
      hintSteps: [
        'Ask what JOB "gracefully" is doing — is it naming a thing, or describing HOW something happens?',
        'Words that describe HOW a verb happens (rises gracefully) are adverbs — always ask what EFFECT the writer\'s word choice has.',
      ],
    },
    {
      id: 'passage-nonfiction-2-q11', tier: 2, format: 'wordentry', skill: 'text', lineRef: null,
      stem: 'How many subheadings, including \'Conclusion\', are used to organise this report?',
      hint: 'a number',
      maxLen: 10,
      accept: ['5', 'five'],
      explain: {
        rule: TEXT_RULE,
        worked: 'Like a contents page listing chapters, this report has five signposts: "Why Things Float Or Sink", "How A Submarine Dives", "How A Submarine Rises Again", "Keeping The Crew Safe", and "Conclusion".',
      },
      hintSteps: [
        'Scroll through the whole report and count every short, stand-alone heading line — including the very last one.',
        'Do not forget "Conclusion" counts as a subheading too!',
      ],
    },
    {

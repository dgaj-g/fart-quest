// FART QUEST — js/pier/modes/teacups.js — STUB (TEACUPS agent builds the real cabinet)
// Single-table warm-up, untimed, no score/PB: lap 1 multiplication, lap 2 the
// division inverses. See docs/PIER_SPEC.md §6 "teacups". This stub is
// deliberately trivial — the TEACUPS agent overwrites the whole file, so
...
export default {
  ...
  mount(host, ctx) {
    injectCss('pier-stub-teacups', CSS);
    ...
    wrap.appendChild(el('div', 'pier-stub-card',
      ...
      + '<h2>THE TEACUPS</h2>'
      + "<p>The teacups are still being painted backstage — check back soon, nose-soldier!</p>"));

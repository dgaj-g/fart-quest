// FART QUEST — js/pier/modes/ghost.js — STUB (GHOST agent builds the real cabinet)
// 20-fact time trial vs your own PB ghost cart on a parallel tunnel track.
// See docs/PIER_SPEC.md §6 "ghost". This stub is deliberately trivial — the
// GHOST agent overwrites the whole file, so nothing here needs to survive.
...
export default {
  ...
  mount(host, ctx) {
    ...
    wrap.appendChild(el('div', 'pier-stub-card',
      ...
      + "<p>The tracks are still being laid backstage — check back soon, nose-soldier!</p>"));

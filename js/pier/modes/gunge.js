// FART QUEST — js/pier/modes/gunge.js — STUB (GUNGE agent builds the real cabinet)
// Survival mode: a draining plank-height gauge, numpad entry, correct answers
// boost it, wrong/slow answers lurch it down. See docs/PIER_SPEC.md §6 "gunge".
// This stub is deliberately trivial — the GUNGE agent overwrites the whole
...
export default {
  ...
  mount(host, ctx) {
    ...
    wrap.appendChild(el('div', 'pier-stub-card',
      ...
      + '<h2>THE GUNGE TANK</h2>'
      + "<p>The vat's still bubbling away backstage — check back soon, nose-soldier!</p>"));
